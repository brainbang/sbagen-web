...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('sbagen.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('sbagen.wasm', import.meta.url).href;
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['signal_handler'] != 'undefined', 'missing Wasm export: signal_handler');
  _signal_handler = Module['_signal_handler'] = createExportWrapper('signal_handler', 1);
